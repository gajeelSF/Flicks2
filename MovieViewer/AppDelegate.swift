...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "play-icon")
        ...
        topRatedNavigationController.tabBarItem.image = UIImage(named: "39-512")
        
        let tarBarController = UITabBarController()
        tarBarController.viewControllers = [nowPlayingNavigationController, topRatedNavigationController]
